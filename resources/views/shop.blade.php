                        ...
                        <div class="product-card bg-white rounded-lg shadow-sm overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <div class="text-sm text-gray-500 mb-2">
                                    {{ optional($product->brand)->name ?? 'No Brand' }}
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    @endif
                                    <button class="bg-blue-600 text-white p-2 rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
