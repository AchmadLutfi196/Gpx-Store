            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center">
                    ...
                    <a href="{{ route('cart') }}" class="relative inline-flex items-center p-2">
                        ...
                        <span class="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full cart-count">
